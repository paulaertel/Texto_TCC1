...
\begin{enumerate}
	\item[(i)] Existe $\boldsymbol{\mu} \in \RR^{r(x^{*})}$ tal que $\nabla f(x^{*}) + W_{\mathcal{I}}^{T} \boldsymbol{\mu} =0$ e $\mu_{i_k} \geq 0$ para todo $i_{k} \in \mathcal{I}(x^{*})$;
...
\[
\nabla f(x^{*}) + W_{\mathcal{I}}^{T} \boldsymbol{\mu} =0 \quad \text{e} \quad \mu_{i_k} \geq 0,
\] 
...
\begin{enumerate}
	\item[(i)] $\nabla f(x^{*}) + W_{\mathcal{I}}^{T} \boldsymbol{\mu} =0$ com $\mu_{i_{k}} \geq 0$ para todo $i_{k} \in \mathcal{I}(x^{*})$, e 
	\item[(ii)] $y^{T} \nabla^{2} f(x^{*})y > 0$ para todo $y \in \mathcal{N}(W_{\mathcal{J}})$, $y\neq 0$, em que $\mathcal{J} = \{ k\in \{ 1,2, \ldots , r(x^{*}) \} \mid \mu_{i_{k}} >0 \}$,
\end{enumerate}
então $x^{*}$ é um minimizador local de \eqref{problema_geral_minimizacao_desigualdade}.
\end{teo}
\begin{proof}
Primeiramente, se $\mu_{i_k} >0$ para todo $i_k \in \mathcal{I}(x^{*})$, então
\[
...
Agora, suponha que existe pelo menos um $k$ tal que $\mu_{i_k} =0$. Neste caso, observe que
\[
W_{\mathcal{I}}^{T} \boldsymbol{\mu} = W_{\mathcal{J}}^{T} \boldsymbol{\mu}_{\mathcal{J}},
\]
em que $\boldsymbol{\mu}_{\mathcal{J}}$ é um subvetor de $\boldsymbol{\mu}$ cujas componentes $\mu_{i_k}$ são as que possuem índice em $\mathcal{J} = \{ k\in \{ 1,2, \ldots , r(x^{*}) \} \mid \mu_{i_{k}} >0 \}$. Desse modo, temos que $x^{*} \in \Omega$ satisfaz
\[
