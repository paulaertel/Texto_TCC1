...
\nabla f(x^{*}) = A^{T} \boldsymbol{\lambda}^{*} ,
\]
e de \eqref{eq:2_condicao_suficiente_igualdade} resulta que para todo $y \in \mathcal{N}(A)$, 
...
\begin{prop}(\textbf{Condição suficiente de segunda ordem}) \label{teo:condicao_suficiente_2ordem_igualdade}
...
Sejam $f \in \mathcal{C}^{2}$, $x^{*}$ um minimizador local do problema \eqref{problema_geral_minimizacao_desigualdade}, e $r(x^{*})$ e $\mathcal{I}(x^{*})$ definidos como anteriormente. Então
\begin{enumerate}
	\item[(i)] Existe $\boldsymbol{\mu} \in \RR^{r(x^{*})}$ tal que $\nabla f(x^{*}) + W_{\mathcal{I}}^{T} \boldsymbol{\mu} =0$ e $\mu_{i} \geq 0$ para todo $i \in \mathcal{I}(x^{*})$;
...
\[
\nabla f(x^{*}) W_{\mathcal{I}}^{T} \boldsymbol{\mu} =0 \quad \text{e} \quad \mu_{i} \geq 0,
\] 
...
Sejam $f \in \mathcal{C}^{2}$, $x^{*} \in \Omega$, e $r(x^{*})$ e $\mathcal{I}(x^{*})$ definidos como anteriormente. Se 
\begin{enumerate}
	\item[(i)] $\nabla f(x^{*}) + W_{\mathcal{I}}^{T} \boldsymbol{\mu} =0$ com $\mu_{i} \geq 0$ para todo $i \in \mathcal{I}(x^{*})$, e 
	\item[(ii)] $y^{T} \nabla^{2} f(x^{*})y > 0$ para todo $y \in \mathcal{N}(W_{\mathcal{J}})$, $y\neq 0$, em que $\mathcal{J} = \{ i\in \{ 1,2, \ldots , r(x^{*}) \} \mid \mu_{i} >0 \}$,
\end{enumerate}
