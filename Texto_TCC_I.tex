...
\begin{lema} {\cite[p. 52]{Ademir2013}}  \label{lema_unicidadeprojecao_convexidade}
...
No \Cref{lema_unicidadeprojecao_convexidade} denotamos $\bar{z} = \proj_{S} (z)$.


\begin{teo} {\cite[p. 53]{Ademir2013}} \label{lema_condicaoprojecao_convexidade}
...
\begin{lema} {\cite[p. 54]{Ademir2013}}  \label{lema_defineprojecao_convexidade}
...
\begin{lema} {\cite[p. 54]{Ademir2013}}
...
\begin{defi} {\cite[56]{Ademir2013}},  \label{defi:funcao_convexa}
...
\begin{teo} {\cite[p. 58]{Ademir2013}} \label{teo:diferenciabilidade_e_convexidade}
...
\begin{teo} {\cite[p.60]{Ademir2013}} \label{teo:hessiana_convexidade}
